...
const CACHE = 'tank-realms-new-design-v29.3';
const GAME = encodeURI('./tank_realms_new_design_v29.3.html');
const ASSETS = ['./', './index.html', GAME, './manifest.webmanifest',
                './icon-192.png', './icon-512.png', './icon-maskable-512.png', './hud-trophy.png', './hud-coins.png'];
